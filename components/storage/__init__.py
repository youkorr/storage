...
StorageFile = storage_ns.class_('StorageFile', audio.AudioFile, cg.Component)  # Héritage double
...
async def to_code(config):
    ...
    for file in config[CONF_FILES]:
        ...
        await cg.register_component(file_var, file)  # Enregistre comme Component
